defmodule AVLTree do
  ...
  @spec inorder_traverse(t()) :: [value()]
  def inorder_traverse(%__MODULE__{root: root, less: less}) do
    Node.inorder_traverse(root)
  end

  @spec get_next_larger(t(), value()) :: value()
  def get_next_larger(%__MODULE__{root: root, less: less}, value) do
    Node.get_next_larger(root, value, nil, less, Node.find_leftmost_child(root))
  end
