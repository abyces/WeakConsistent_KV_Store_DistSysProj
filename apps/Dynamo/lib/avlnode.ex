defmodule AVLTree.Node do
  ...
  def find_leftmost_child({v, h, l, r}) do
    case l do
      nil -> {v, h, l, r}
      _ -> find_leftmost_child(l)
    end
  end

  def get_next_larger(nil, _value, default, _less, parent), do: elem(parent, 0)

  def get_next_larger({v, _h, l, r}, value, default, less, parent) do
    if v == value do
      case r do
        nil -> elem(parent, 0)
        right -> elem(find_leftmost_child(right), 0)
      end
    else
      case less.(value, v) do
        true -> get_next_larger(l, value, default, less, {v, _h, l, r})
        false -> get_next_larger(r, value, default, less, parent)
      end
    end
  end
