...
#  end
#
#  test "test get() function (and context merge: 1->1 [a1], 1->2 [a2])" do
#    Emulation.init()
#    new_loadbalancer = LoadBalancer.new_loadbalancer([:a, :b, :c], 1000, 1, 500)
#
#    spawn(:loadbalancer, fn ->
...
#  end
#
#  test "teat temporary failure detectiong & handling: hinted handoff, gossip table" do
#    Emulation.init()
...
#      end
#
#      send(:d, :read_gossip_table)
#
#      receive do
#        {sender, gossip_table} -> assert elem(gossip_table[:e], 2) == :alive
#      end
#
#      send(:e, {:read_replica, "1"})
#
#      receive do
...
#
#
#  test "test data versioning & context merge when network partition recovered" do
#    Emulation.init()
#    new_loadbalancer = LoadBalancer.new_loadbalancer([:a, :b, :c], 1000, 1, 500)
#
#    spawn(:loadbalancer, fn ->
...
#  end
#
#  test "test replica works or not" do
#    Emulation.init()
